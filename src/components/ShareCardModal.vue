    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">会议模板与框架</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 会议模板与分钟级议程生成</span>
...
// 清理回复末尾的特殊标记 [HUIYI_SCORES]...[/HUIYI_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[HUIYI_SCORES\][\s\S]*?\[\/HUIYI_SCORES\]/gi, '').trim();
});

// 提取会议目标与简短议程作为卡片主体，避免卡片过长
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 会议议程与讨论框架】\n\n${cleanContent.value}\n\n体验高效开会大模型：https://ai.wuxian.xyz`;
